...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/SAS_Curiosity_Cup-2025-E97627?style=flat-square&logo=sas&logoColor=white"/>
  <img src="https://img.shields.io/badge/Portfolio_Project-STEM_MS-C9A84C?style=flat-square"/>
...
| Source | What it provides | Grain | Years |
|--------|-----------------|-------|-------|
| **O\*NET** | 55 work context + 35 skill ratings per occupation | SOC code | Cross-sectional |
| **BLS OEWS** | Employment counts by occupation x metro area | SOC x MSA | 2019, 2023 |
| **BLS Projections** | Occupational separation rates (the churn target) | SOC | 2019, 2023 |

The three datasets merge through employment weighting. O\*NET skill and work-context scores, weighted by OEWS employment counts and averaged into each metro area's profile, produce what we call **Skill DNA** -- a 90-dimension fingerprint of what a region's workforce actually does. BLS separation rates, weighted the same way, form the target variable: regional churn rate. Neither exists in the raw data; both are constructed.
...
<p align="center">
  <img src="assets/model_comparison.png" alt="Table 1 -- Model comparison: Linear Baseline (R²=0.052) vs Gradient Boosting champion (R²=0.768)" width="70%"/>
</p>
...
<p align="center">
  <img src="assets/quadrant_scatter.png" alt="Figure 2 -- False Growth Quadrant: 396 metro areas plotted by Employment Growth vs Predicted Churn Risk" width="85%"/>
</p>
...
<p align="center">
  <img src="assets/feature_importance.png" alt="Figure 1 -- Top Predictors of Regional Churn Risk: Freedom to Make Decisions leads at 0.679 importance" width="65%"/>
</p>
...
<p align="center">
  <img src="assets/employment_comparison.png" alt="Figure 7 -- Top 15 Regions: Employment Comparison 2019 vs 2023" width="75%"/>
</p>
...
```bash
git clone https://github.com/sai-seetal-pendyala/false-growth-early-warning-system.git
cd false-growth-early-warning-system
pip install -r requirements.txt
python code/preprocessing.py
```

**Data sources:** [BLS OEWS](https://www.bls.gov/oes/) and [O\*NET](https://www.onetonline.org/) -- both publicly available.
